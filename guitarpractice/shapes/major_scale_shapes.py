...
def e_phrygian():
    ...
    return GuitarShape('Phrygian', 'scale', positions)
...
def a_aeolian():
    ...
    return GuitarShape('Aeolian', 'scale', positions)
...
def b_locrian():
    ...
    return GuitarShape('Locrian', 'scale', positions)
...
def c_ionian():
    ...
    return GuitarShape('Ionian', 'scale', positions)
