...
from guitarpractice.shapes.chord_collections import movable_chords
...
def list_movable_chords(root: str, tonality: str):
    ...
    for movable_chord in list_movable_chord_shapes(tonality):
        movable_chord_root_positions = [
            position
            for position in movable_chord.positions
            if position.highlighted
        ]
        movable_root_position = movable_chord_root_positions[0]
